...
function Bundle(options) {
  ...
  if (this.options.routes) {
    this.options.routes.forEach(function(route) {
      this.routeMap([route.method || 'get'], route.uri, route.handler);
    }.bind(this));
  }

  if (this.options.bundles) {
    this.options.bundles.forEach(function(bundle) {
...
_.forEach(routeMethods, function(methods, name) {
  'use strict';
  Bundle.prototype['route' + name] = function(pattern, handler) {
    return this.routeMap(methods, pattern, handler);
  };
});

Bundle.prototype.routeMap = function(methods, pattern, handler) {
  'use strict';
